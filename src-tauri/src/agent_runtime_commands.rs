...
use crate::agent_runtime::{
    approval_for_steps, AgentRuntimeService, AgentRuntimeStatus, ApprovalCheck, ApprovalStatus,
...
use crate::github_workflow::{
    ...
    ReadPullRequestRequest, WorkflowLog, WorkflowLogRequest,
};
...
#[tauri::command]
pub fn agent_runtime_open_session(
    app: tauri::AppHandle,
...
#[tauri::command]
pub fn agent_runtime_define_plan(
    app: tauri::AppHandle,
    request: DefineRuntimePlanRequest,
) -> Result<RuntimePlan, String> {
    runtime(&app)?.define_plan(&request.session_id, request.objective, request.steps)
}

#[tauri::command]
pub fn agent_runtime_create_approval(
    app: tauri::AppHandle,
...
#[tauri::command]
pub fn agent_runtime_list_approvals(
    app: tauri::AppHandle,
...
#[tauri::command]
pub fn agent_runtime_resolve_approval(
    app: tauri::AppHandle,
    id: String,
...
#[tauri::command]
pub fn agent_runtime_check_approval(
    app: tauri::AppHandle,
    ...
    let (label, approved, message) = match status {
        ApprovalCheck::Valid => (
            "valid",
            true,
            "Approval is valid for one execution.".to_string(),
        ),
        ApprovalCheck::SessionWide => (
            "session-wide",
            true,
            "Approval is valid for the rest of the session.".to_string(),
        ),
        ApprovalCheck::AlreadyConsumed => (
            "already-consumed",
            false,
            "This approval has already been used.".to_string(),
        ),
        ...
        ApprovalCheck::NotApproved => (
            "not-approved",
            false,
            "Approval was rejected or never approved.".to_string(),
        ),
    };
...
#[tauri::command]
pub fn agent_runtime_browser_tool(
    app: tauri::AppHandle,
...
#[tauri::command]
pub fn agent_runtime_upsert_memory(
    app: tauri::AppHandle,
...
#[tauri::command]
pub fn agent_runtime_retrieve_memories(
    app: tauri::AppHandle,
    project_id: String,
    query: String,
    limit: Option<usize>,
...
#[tauri::command]
pub fn agent_runtime_retrieve_memories_request(
    app: tauri::AppHandle,
    request: RetrieveMemoriesRequest,
) -> Result<Vec<MemoryHit>, String> {
    Ok(runtime(&app)?.retrieve_memories(
        &request.project_id,
        &request.query,
...
#[tauri::command]
pub fn agent_runtime_github_create_branch(
...
#[tauri::command]
pub fn agent_runtime_github_create_pr(
...
#[tauri::command]
pub fn agent_runtime_github_read_pr(
...
#[tauri::command]
pub fn agent_runtime_github_ci_status(
    request: CiStatusRequest,
) -> Result<github_workflow::CiStatus, String> {
...
#[tauri::command]
pub fn agent_runtime_github_workflow_log(
    request: WorkflowLogRequest,
) -> Result<WorkflowLog, String> {
    github_workflow::read_workflow_log(request)
}

#[tauri::command]
pub fn agent_runtime_upsert_memory_v2(
    app: tauri::AppHandle,
    memory: memory_mod::Memory,
) -> Result<memory_mod::Memory, String> {
    memory_store(&app)?.upsert(memory)
}

#[tauri::command]
pub fn agent_runtime_retrieve_memories_v2(
    app: tauri::AppHandle,
    request: RetrieveMemoriesRequest,
) -> Result<Vec<memory_mod::MemoryHit>, String> {
...
#[tauri::command]
pub fn agent_runtime_inject_memories(
    app: tauri::AppHandle,
    request: InjectMemoriesRequest,
) -> Result<InjectMemoriesResult, String> {
